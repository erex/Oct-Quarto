...
```{r}
#| out.width = "60%",
#| fig.cap = "Downward view of aerial survey, with distance bands 
#| emanating from the transect.  Note area directly underneath 
#| plane where detections are not possible.",
#| echo = FALSE
