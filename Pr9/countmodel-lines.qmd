...
#| label = "grandplot",
#| column = "body-outset",
#| fig.cap = "Relationship between univariate predictor and Brewer's sparrow density as modelled by GLM.  Offset is  estimated covered area. Confidence intervals incorporate  uncertainty from imperfect detectability. Inset is sampling  distribution of the parameter of interest for Brewer's sparrow.",
#| fig.height = 5.5
...
```{r}
#| label = "slope",
#| fig.cap = "Sampling distribution of the parameter of interest for Brewer's sparrow."
