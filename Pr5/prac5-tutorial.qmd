...
- To the nearest 5%, what is the relative percentage difference between smallest and largest estimates? `r fitb(15)`
...
- How much larger (nearest 5%) is 5-minute density estimate than snapshot density estimate? `r fitb(25)`
- Which data collection method produces the more precise estimate (by a considerable amount)? `r mcq(c("5 minute", answer="snapshot"))`
