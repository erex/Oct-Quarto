...
```{r}
#| fig.cap = "Selection for best half normal model.",
#| echo = FALSE,
#| out.width = "200%",
#| eval=FALSE
...
```{mermaid}
stateDiagram-v2
partition "ds(data, key="hn", adj="cos")" 
fork
  :hn(0)
  AIC=2817;
fork again
...
```{r}
#| fig.cap = "Selection for best uniform model.",
#| echo = FALSE,
#| out.width = "200%",
#| eval = FALSE
...
```{mermaid}
!theme cerulean
partition "ds(data, key="unif", adj="cos")" 
fork
  :unif(1)
  AIC=2811;
fork again
...
```{r}
#| fig.cap = "Selection for best hazard rate model.",
#| echo = FALSE,
#| out.width = "200%",
#| eval=FALSE
...
```{mermaid}
!theme cerulean
partition "ds(data, key="hr", adj="cos")" 
fork
  :hr(0)
  AIC=2805;
fork again
...
```{r}
#| fig.cap = "Stage two of model selection.",
#| echo = FALSE,
#| out.width = "200%",
#| eval = FALSE
...
```{mermaid}
!theme cerulean
partition "summarise_ds_models(hn1, unif3, hr0)" 
fork
  :hn(1)
  AIC=2806;
fork again
